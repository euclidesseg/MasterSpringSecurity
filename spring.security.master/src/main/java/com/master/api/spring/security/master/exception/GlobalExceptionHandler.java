...
// controla excepciones Cuando se coloca esta anotación en una clase, Spring Boot la detecta y la utiliza para manejar excepciones lanzadas desde cualquier controlador REST en la aplicación.
